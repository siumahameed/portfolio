...
import { Inter, JetBrains_Mono, Space_Grotesk, Exo_2 } from "next/font/google";
import "./globals.css";
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: "(function(){try{var t=localStorage.getItem('theme');if(!t||t==='dark')document.documentElement.classList.add('dark')}catch(e){}document.documentElement.classList.add('js')})()",
          }}
        />
      </head>
      <body
        className={`${inter.variable} ${jetbrainsMono.variable} ${spaceGrotesk.variable} ${exo2.variable} font-sans antialiased`}
